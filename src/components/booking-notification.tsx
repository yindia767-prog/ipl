...
export function BookingNotification() {
  ...
  useEffect(() => {
    ...
    const scheduleNext = () => {
      // Delay between 30 seconds and 150 seconds (2.5 minutes)
      const delay = Math.floor(Math.random() * (150000 - 30000 + 1)) + 30000;
    ...
    // Start the first notification after 15 seconds
